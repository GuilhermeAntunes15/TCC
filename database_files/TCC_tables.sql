...
CREATE TABLE T_REQUERIMENTO(
    CD_REQUERIMENTO INT(11) Primary key auto_increment,
    REQ_NOME VARCHAR(30),
    REQ_DESCRICAO TEXT,
    REQ_FL_REQUERIMENTO_ATIVO_SN varchar(1), 
    REQ_DT_AUDITORIA_ALTERACAO DATETIME,
    REQ_DS_AUDITORIA_LOGIN TEXT
);
